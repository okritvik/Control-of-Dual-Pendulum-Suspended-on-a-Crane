...
%Linearized using Jacobian Linearization
clc;
clear all;
close all;
...
disp(['Rank of Controllability Matrix is ',num2str(rank(C))]);
%For the system to be controllable, it should be non singular. That means
%the determinant of the controllability matrix should not be equal to zero.
disp("For the system to be controllable, the determinant of the controllability matrix should be non singular")
det(C) %!=0